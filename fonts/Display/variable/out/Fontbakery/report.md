...
* ℹ **INFO** From a total of 1 font files, 0 of them (0.00%) lack a STAT table.
	...
	('wght', 1) [code: summary]
</div></details><br></div></details><details><summary><b>[13] WixMadeforDisplay[wght].ttf</b></summary><div><details><summary>🔥 <b>FAIL:</b> Check Google Fonts glyph coverage. (<a href="https://font-bakery.readthedocs.io/en/stable/fontbakery/profiles/googlefonts.html#com.google.fonts/check/glyph_coverage">com.google.fonts/check/glyph_coverage</a>)</summary><div>
...
* ℹ **INFO** Hinting filesize impact:
 ...
 |               | WixMadeforDisplay[wght].ttf          |
 |:------------- | ---------------:|
 | Dehinted Size | 375.4kb |
 | Hinted Size   | 375.4kb   |
 | Increase      | 24 bytes      |
 | Change        | 0.0 %  |
 [code: size-impact]
